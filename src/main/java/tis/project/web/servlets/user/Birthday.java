...
import static tis.project.web.components.users.UserResources.getBirthday;
import static tis.project.web.helpers.Validator.validateData;

@WebServlet(name = "userBirthday", urlPatterns = "/api/user/birthday")
