...
import static tis.project.web.components.users.UserResources.getNickname;
import static tis.project.web.helpers.Validator.validateInputData;

@WebServlet(name = "userNickname", urlPatterns = "/api/user/nickname")
